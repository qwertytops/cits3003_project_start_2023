...
void MasterRenderScene::insert_dlight(std::shared_ptr<DirectionalLight> directional_light) {
    light_scene.directional_lights.insert(std::move(directional_light));
}

bool MasterRenderScene::remove_dlight(const std::shared_ptr<DirectionalLight>& directional_light) {
